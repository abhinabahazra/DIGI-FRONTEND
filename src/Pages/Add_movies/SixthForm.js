                    ...
                    if(resTrailer1.status === "success"){
                        this.videoUpload('movie').then((resMovie) => {
                            if(resMovie.status === "success"){
                                this.setState({uploadTitle: "banner2 is uploading"});
                                axios.post('https://www.api3.digimovieplex.com/api/upload_banner2', banner_two).then(()=>{
                                    this.setState({uploadTitle: "screenshot1 is uploading"});
                                    axios.post('https://www.api3.digimovieplex.com/api/upload_screenshot1', screenshot_one).then(()=>{
                                        this.setState({uploadTitle: "screenshot2 is uploading"});
                                        axios.post('https://www.api3.digimovieplex.com/api/upload_screenshot2', screenshot_two).then(()=>{
                                            this.setState({uploadTitle: "screenshot3 is uploading"});
                                            axios.post('https://www.api3.digimovieplex.com/api/upload_screenshot3', screenshot_three).then(()=>{
                                                this.setState({uploadTitle: "screenshot4 is uploading"});
