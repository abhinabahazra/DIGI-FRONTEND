        ...
        if (movieWatchStatus) {
          return (
              ...
              <Button variant="contained" className="watch_movie_button"
                startIcon={<PlayCircleOutlineIcon />}
                color="secondary">
                <Link to={`/media_player/${movieLink}/${rating}`} onClick={refreshPage}>Movie</Link>
              </Button>
              ...
              <div className="ContentModal">
                ...
                <div className="ContentModal__about">
                  ...
                  <div className="modal_button">
                    ...
                    color="secondary">
                    <Link to={`/trailer/${encodeURIComponent(trailer1)}/${encodeURIComponent(rating)}`} onClick={refreshPage}>Trailer 1</Link>
                  </Button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <Button variant="contained"
                        className="trailer_two"
                          startIcon={<BookIcon />}
                          color="secondary" >
                            <Link to={`/read_more/${encodeURIComponent(JSON.stringify({mid: movie_id, mtitle: title }))}`}>Read More</Link>
